    ...
    <html lang="en" className={`${sarabun.variable}`}>
      <body className="antialiased">
        <div className="bg-cover bg-center flex flex-col items-center sm:bg-gray-100 min-h-screen">
          <div className="fixed w-full sm:max-w-[450px] top-0 bg-white z-[98] text-center font-bold py-4 mb-2 text-[22px] text-[#DE3163] border-b-[1px]">
            เกมวงเหล้า!
            <div className="text-xs mb-2 text-black">Version: 1.0.1</div>
